...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal get(int id, int userId) {
        List<Meal> meals = jdbcTemplate
                .query("SELECT * FROM meals WHERE id=:id AND user_id=:userId", ROW_MAPPER, id, userId);
    ...
    public List<Meal> getAll(int userId) {
        return jdbcTemplate
                .query("SELECT * FROM meals WHERE user_id=:userId ORDER BY date_time DESC", ROW_MAPPER, userId);
    }
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate
                .query("SELECT * FROM meals WHERE user_id=:userId" +
                        " AND date_time BETWEEN :startDate AND :endDate ORDER BY date_time DESC"
